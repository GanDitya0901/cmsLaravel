@admin
<x-admin-layout>
    <h1 class="font-bold text-2xl mb-3">Category Update</h1>
    <div class="flex justify-center">
        <div class="p-5 shadow-lg rounded-md bg-white w-full max-w-2xl">
            <form action="{{ route('editCategory', $category->id) }}" method="POST" class="grid grid-cols-4 gap-5"
                ...
                <div class="col-span-2">
                    ...
                    <input type="text" placeholder="Enter name" name="name" value="{{ $category->name }}"
                ...
                <div class="col-span-2">
                    ...
                    <input type="text" placeholder="Enter slug" name="slug" value="{{ $category->slug }}"
