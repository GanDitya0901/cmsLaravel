    ...
    <div class="p-3 shadow-lg rounded-md w-full">
        <div class="flex justify-between mb-1">
            ...
            <div class="flex justify-between gap-2">
                <form action="{{ route('show.allPages') }}" method="GET"
                ...
                @foreach ($pages as $data)
                    <tr class="*:p-4 odd:bg-gray-100">
                        ...
                        <td class="flex items-center">
                            <a href="{{ route('show.pageEditForm', $data->id) }}"
                                class="mx-2 p-2 bg-amber-300 rounded-md hover:bg-amber-400 hover:text-white">Update</a>
                            <a href="{{ route('show.section', $data->id) }}"
                                class="mx-2 p-2 bg-amber-300 rounded-md hover:bg-amber-400 hover:text-white">Section</a>
                            <div x-data="{ openModal: false }">
                                ...
                                <div x-show="openModal"
                                    ...
                                    <div class="flex w-96 flex-col items-center gap-3 rounded-md bg-white p-6 shadow-md"
                                        ...
                                        <p class="text-gray-500">This action will permanently delete the page</p>
